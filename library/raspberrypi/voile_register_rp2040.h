...
#define voile_rp2040_IO_BANK0_BASE 0x40014000u
#define voile_rp2040_IO_BANK0 ((voile_rp2040_IO_BANK0_t *)voile_rp2040_IO_BANK0_BASE)
#define voile_rp2040_IO_BANK0_XOR ((voile_rp2040_PADS_BANK0_t *)(voile_rp2040_IO_BANK0_BASE+0x1000u))
#define voile_rp2040_IO_BANK0_MuskSet ((voile_rp2040_PADS_BANK0_t *)(voile_rp2040_IO_BANK0_BASE+0x2000u))
#define voile_rp2040_IO_BANK0_MuskClear ((voile_rp2040_PADS_BANK0_t *)(voile_rp2040_IO_BANK0_BASE+0x3000u))
...
typedef struct {
    ...
    // Voltage select
    // 0x00000001 [0]     : VOLTAGE_SELECT (0) : Voltage select. Per bank control
...
#define voile_rp2040_PADS_BANK0_BASE 0x4001c000u
#define voile_rp2040_PADS_BANK0 ((voile_rp2040_PADS_BANK0_t *)voile_rp2040_PADS_BANK0_BASE)
#define voile_rp2040_PADS_BANK0_XOR ((voile_rp2040_PADS_BANK0_t *)(voile_rp2040_PADS_BANK0_BASE+0x1000u))
#define voile_rp2040_PADS_BANK0_MuskSet ((voile_rp2040_PADS_BANK0_t *)(voile_rp2040_PADS_BANK0_BASE+0x2000u))
#define voile_rp2040_PADS_BANK0_MuskClear ((voile_rp2040_PADS_BANK0_t *)(voile_rp2040_PADS_BANK0_BASE+0x3000u))
...
#define voile_rp2040_UART0 ((voile_rp2040_UART_t *)(0x40034000u))
#define voile_rp2040_UART1 ((voile_rp2040_UART_t *)(0x40038000u))
#define voile_rp2040_UART_XOR(x) ((voile_rp2040_UART_t *)((uint32_t)x+0x1000u))
#define voile_rp2040_UART0_XOR ((voile_rp2040_UART_t *)(0x40034000u+0x1000u))
#define voile_rp2040_UART1_XOR ((voile_rp2040_UART_t *)(0x40038000u+0x1000u))
#define voile_rp2040_UART_MuskSet(x) ((voile_rp2040_UART_t *)((uint32_t)x+0x2000u))
#define voile_rp2040_UART0_MuskSet ((voile_rp2040_UART_t *)(0x40034000u+0x2000u))
#define voile_rp2040_UART1_MuskSet ((voile_rp2040_UART_t *)(0x40038000u+0x2000u))
#define voile_rp2040_UART_MuskClear(x) ((voile_rp2040_UART_t *)((uint32_t)x+0x3000u))
#define voile_rp2040_UART0_MuskClear ((voile_rp2040_UART_t *)(0x40034000u+0x3000u))
#define voile_rp2040_UART1_MuskClear ((voile_rp2040_UART_t *)(0x40038000u+0x3000u))



// Reference to datasheet: https://datasheets.raspberrypi.com/rp2040/rp2040-datasheet.pdf#tab-registerlist_sio
typedef struct {
    // Processor core identifier, CPUID
    // 0x00000001 [31:0]  : (-) : Processor core identifier
    // Value is 0 when read from processor core 0, and 1 when read from processor core 1
    io_ro_32 CPUID;

    // Input value for GPIO pins, GPIO_IN
    // 0x00000001 [29:0]  : (0) : Input value for GPIO0…29
    io_ro_32 GPIO_IN;
    ...
    // 0x00000001 [29:0]  : (0) : Set output level (1/0 → high/low) for GPIO0…29
    // Reading back gives the last value written, NOT the input value from the pins. If core 0 and core 1 both write to GPIO_OUT simultaneously (or to a SET/CLR/XOR alias), the result is as though the write from core 0 took place first, and the write from core 1 was then applied to that intermediate result.
    io_rw_32 GPIO_OUT;

    // GPIO output value set, GPIO_OUT_SET
    // 0x00000001 [29:0]  : (0) : Perform an atomic bit-set on GPIO_OUT, i.e. GPIO_OUT |= wdata
    io_wo_32 GPIO_OUT_SET;

    // GPIO output value clear, GPIO_OUT_CLR
    // 0x00000001 [29:0]  : (0) : Perform an atomic bit-clear on GPIO_OUT, i.e. GPIO_OUT &= ~wdata
    io_wo_32 GPIO_OUT_CLR;

    // GPIO output value XOR, GPIO_OUT_XOR
    // 0x00000001 [29:0]  : (0) : Perform an atomic bitwise XOR on GPIO_OUT, i.e. GPIO_OUT ^= wdata
    io_wo_32 GPIO_OUT_XOR;

    // GPIO output enable, GPIO_OE
    // 0x00000001 [29:0]  : (0) : Set output enable (1/0 → output/input) for GPIO0…29
    // Reading back gives the last value written. If core 0 and core 1 both write to GPIO_OE simultaneously (or to a SET/CLR/XOR alias), the result is as though the write from core 0 took place first, and the write from core 1 was then applied to that intermediate result.
    io_rw_32 GPIO_OE;

    // GPIO output enable set, GPIO_OE_SET
    // 0x00000001 [29:0]  : (0) : Perform an atomic bit-set on GPIO_OE, i.e. GPIO_OE |= wdata
    io_wo_32 GPIO_OE_SET;

    // GPIO output enable clear, GPIO_OE_CLR
    // 0x00000001 [29:0]  : (0) : Perform an atomic bit-clear on GPIO_OE, i.e. GPIO_OE &= ~wdata
    io_wo_32 GPIO_OE_CLR;

    // GPIO output enable XOR, GPIO_OE_XOR
    // 0x00000001 [29:0]  : (0) : Perform an atomic bitwise XOR on GPIO_OE, i.e. GPIO_OE ^= wdata
...
#define voile_rp2040_SIO ((voile_rp2040_SIO_t *)0xd0000000u)
